...
filestoTransferTT  = [environ["CMSSW_BASE"] + "/src/SusyAnaTools/Tools/condor/sampleSets_preProcess_2016.cfg",
                      ...
                      environ["CMSSW_BASE"] + "/src/SusyAnaTools/Tools/condor/bTagEfficiencyCalc",
                      ]

#go make BTagEff plots!
...
sc = SampleSet("sampleSets_preProcess_2016.cfg")
